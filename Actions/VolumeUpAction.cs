...
public sealed class VolumeUpAction : SpiceActionBase
{
    public override string Name => "Spotify: Volume Up";
    public override string Description => "Increase volume by a step";
